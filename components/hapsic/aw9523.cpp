...
{
    if (!writeRegister8(AW9523_REG_OUTPUT0, pins & 0xFF)) return false;
    if (!writeRegister8(AW9523_REG_OUTPUT0 + 1, pins >> 8)) return false;
    return true;
}
...
{
    if (!writeRegister8(AW9523_REG_INTENABLE0, ~(pins & 0xFF))) return false;
    if (!writeRegister8(AW9523_REG_INTENABLE0 + 1, ~(pins >> 8))) return false;
    return true;
}
...
{
    if (!writeRegister8(AW9523_REG_CONFIG0, ~(pins & 0xFF))) return false;
    if (!writeRegister8(AW9523_REG_CONFIG0 + 1, ~(pins >> 8))) return false;
    return true;
}
