...
class M5_STAMPLC {
 public:
  ...
  /**
   * @brief Get the current output current measurement of the right side io
   * socket
   *
  ...
  /**
   * @brief Get the IOExpander A, this is the IOExpander that controls the
   * status light and button A/B/C
   *
  ...
  /**
   * @brief Get the IOExpander B, this is the IOExpander that controls the plc
   * relays and plc inputs
   *
   * @return AW9523_Class&
   */
